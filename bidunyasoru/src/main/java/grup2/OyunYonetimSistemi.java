...
public class OyunYonetimSistemi {
    ...
    public ArrayList<Oyuncu> readUsersFromJson(){
        ...
        try {
            ...
            //JSONArray jsonArray = (JSONArray)parser.parse(new FileReader("/src/main/resources/data/" + "users.json"));
    ...
    public ArrayList<Ulke> ulkeOku() throws IOException {
        ...
        try {
            String fileName = "/data/ulkeler/"+"ulkeler.csv";
            ...
            FileReader ulkelerCSVFileReader = new FileReader(file);
            ...
            while ((tmpLine = UlkelerCSVBufferReader.readLine()) != null) {
                ...
                File tmpFile = new File(classLoader.getResource(filepath).getFile());
                String path = URLDecoder.decode(tmpFile.getAbsolutePath(), "UTF-8");

                // Gecici ulkeye ait soru dosyasinin FileReader'i olusturulur
                FileReader questionCSVFileReader = new FileReader(path);
